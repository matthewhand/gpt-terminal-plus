...
describe('Route Command Handlers', () => {
  ...
  describe('executeFile handler', () => {
    it('should handle missing filename in request body', async () => {
      mockRequest.body = {};
    ...
    it('should handle valid filename', async () => {
      mockRequest.body = { filename: '/tmp/test.sh' };
    ...
    it('should handle various input validation patterns', async () => {
      ...
      const testCases = [
        ...
        },
        {
          ...
          validInput: { filename: '/tmp/test.txt' },
