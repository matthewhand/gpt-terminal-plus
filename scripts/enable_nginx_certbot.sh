...
services=(
  "ssh-cli:5005:docker/ssh-cli/docker-compose.yml"
  "oci-cli:5006:docker/oci-cli/docker-compose.yml"
  "aws-cli:5007:docker/aws-cli/docker-compose.yml"
  "notion-sdk:5008:docker/notion-sdk/docker-compose.yml"
  "joplin:5009:docker/joplin/docker-compose.yml"
)
