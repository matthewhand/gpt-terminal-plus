...
import { getSelectedModel, getSelectedServer, getPresentWorkingDirectory } from "../../utils/GlobalStateHelper.js";
import { chatForServer } from "../../llm.js";
import { ServerManager } from "../../managers/ServerManager.js";
import { evaluateCommandSafety } from "../../utils/safety.js";
import { spawn, spawnSync } from "child_process";
import { executeCommand as executeLocalCommand } from "../../handlers/local/actions/executeCommand.js";
import express from "express";
import { checkAuthToken } from "../../middlewares/checkAuthToken.js";
import { listExecutors, setExecutorEnabled } from "../../utils/executors.js";
 ...
 * Prefers shell > code. Returns 409 if none are enabled.
 */
export const executeCommand = async (req: Request, res: Response) => {
  ...
  return res.status(409).json({
    error: {
      ...
      message: 'No execution modes are enabled. Configure Shell/Code in Setup.',
    },
  });
};
